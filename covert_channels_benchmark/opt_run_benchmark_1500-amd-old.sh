...
$benchmark/../target/x86_64-unknown-linux-gnu/release/covert_channels_benchmark_opt_1500 > log.txt 2> err.txt
...
mkdir -p ./variable_freq_opt_1500
cp /tmp/numa_cal_variable/*.xz /tmp/numa_cal_variable/*.zst ./variable_freq_opt_1500/
...
mkdir -p ./fixed_freq_opt_1500
cp /tmp/numa_cal_fixed/*.xz /tmp/numa_cal_fixed/*.zst ./fixed_freq_opt_1500/
